...
class UserDaoImpl @Autowired constructor(
    ...
    override fun countByName(name: String): Int {
        val paramMap = mapOf("name" to name, "status" to DBConst.User.statusOpen, "del" to DBConst.falseVal)
    ...
    override fun getById(id: Long): User? {
        val paramMap = mutableMapOf("id" to id, "status" to DBConst.User.statusOpen, "del" to DBConst.falseVal)
