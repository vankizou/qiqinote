            ...
            <div>
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="j_update_pwd_old_pwd" type="password" class="form-control" placeholder="请输入原密码">
                        </td>
                    </tr>
                    <tr>
                        <td class="textRightAndVMiddle">新密码：</td>
                        <td>
                            <input id="j_update_pwd_new_pwd" type="password" class="form-control" placeholder="请输入新密码">
                        </td>
                    </tr>
                    <tr>
