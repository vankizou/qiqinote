/*
 ...
 Source Server         : 腾讯云-北京-140.143.225.238
 Source Server Type    : MySQL
 Source Server Version : 50721
 Source Host           : qiqinote.com:3306
 Source Schema         : qiqinote

 Target Server Type    : MySQL
 Target Server Version : 50721
 File Encoding         : 65001

 Date: 05/09/2018 09:59:53
*/
...
CREATE TABLE `comment` (
  ...
  `del` tinyint(2) DEFAULT '0' COMMENT '是否删除。0否，1是',
  PRIMARY KEY (`id`),
...
CREATE TABLE `config` (
  ...
  `note_tree_config` varchar(200) DEFAULT NULL COMMENT '笔记树页配置',
...
CREATE TABLE `note` (
  ...
  `del` int(2) DEFAULT '0' COMMENT '是否删除. 0否 1是. 默认0',
  PRIMARY KEY (`id`),
  KEY `索引1` (`user_id`),
  KEY `索引2` (`parent_id`),
  KEY `id_link` (`id_link`)
